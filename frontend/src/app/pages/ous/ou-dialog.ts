  ...
  template: `
    ...
    <mat-dialog-content>
      <div style="display: flex; flex-direction: column; gap: 1rem; padding-top: 0.5rem; min-width: 300px;">
        ...
        <div *ngIf="!data.isEdit && data.parentDN" style="font-size: 0.85rem; color: #888; margin-bottom: 0.5rem;">
          Se creará dentro de: <br/> <strong>{{ data.parentDN }}</strong>
        </div>

        <mat-form-field appearance="outline">
          <mat-label>Nombre de la OU</mat-label>
          <input matInput [(ngModel)]="ou.name" required [disabled]="data.isEdit">
        </mat-form-field>
        <mat-form-field appearance="outline">
          <mat-label>Descripción</mat-label>
          <textarea matInput [(ngModel)]="ou.description" rows="3"></textarea>
        </mat-form-field>
      </div>
    </mat-dialog-content>
...
export class OuDialog {
  ou: any;
  constructor(
    public dialogRef: MatDialogRef<OuDialog>,
